...
export const Process = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      enTitle: "Completion",
      jpTitle: "完成",
      desc: "数百時間をかけた設計と数百時間をかけた組み立て作業を経て、ようやくひとつの作品が完成します。大型になればなるほど、期間が掛かればかかるほど、完成した時の達成感はひとしおです。",
      images: [imgProcess6],
    },
    {
      id: "07",
    ...
    },
    {
      ...
      enTitle: "Exhibition",
      jpTitle: "展示",
      desc: "大学の学祭やレゴのイベント、オフ会などに持っていって展示します。実物を見ていただけるのはとても貴重な機会なので、できるだけたくさんの展示会に持っていきます。見せ方、説明、展示会場までの運搬など、こちらもたくさんの工夫の余地があって楽しいポイントです。",
      images: [imgQE4],
    }
  ];
